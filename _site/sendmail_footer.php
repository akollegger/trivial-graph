...
if(isset($_POST['email1'])){
		...
		$the_email 		= $_POST['email1'];
		$the_name 		= $_POST['yourname1'];
		$the_message 	= $_POST['message1'];

		$the_phone 		= $_POST['phone1'];
		$the_fax 		= $_POST['fax1'];
		$the_company 	= $_POST['company1'];
		$the_website 	= $_POST['website1'];
		...
		$already_used = array('email1','yourname1','message1','phone1','fax1','company1','website1','myblogname1','tempcode1','temp_url1','ajax');
		$attach = '';
